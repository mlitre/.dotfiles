-- Rendered by Noctalia into lua/noctalia.lua (git-ignored). Do not edit the output.
-- Used only when the active `dot theme` is not kanagawa (see plugins/colorscheme.lua).
local M = {}
M.mode = "{{ mode }}"
M.palette = {
