...
-- dot: Omarchy-style system menu and helpers (~/.local/bin/dot)
hl.bind(mainMod .. " + ALT + Space",           hl.dsp.exec_cmd("dot menu"))
...
hl.bind(mainMod .. " + Print",         hl.dsp.exec_cmd("dot screenshot annotate"))
hl.bind(mainMod .. " + SHIFT + Print", hl.dsp.exec_cmd(noctCall .. "screenshot-fullscreen all"))
